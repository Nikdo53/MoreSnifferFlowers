...
public class ModItemTagsProvider extends BlockTagCopyingItemTagProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
       ...
       // this.tag(net.minecraft.tags.ItemTags.TRIM_TEMPLATES).add(MSFItems.AROMA_ARMOR_TRIM_SMITHING_TEMPLATE.get(), MSFItems.CARNAGE_ARMOR_TRIM_SMITHING_TEMPLATE.get(), MSFItems.NETHER_WART_ARMOR_TRIM_SMITHING_TEMPLATE.get(), MSFItems.TATER_ARMOR_TRIM_SMITHING_TEMPLATE.get(), MSFItems.CAROTENE_ARMOR_TRIM_SMITHING_TEMPLATE.get(), MSFItems.GRAIN_ARMOR_TRIM_SMITHING_TEMPLATE.get(), MSFItems.BEAT_ARMOR_TRIM_SMITHING_TEMPLATE.get());
        ...
        this.tag(MSFTags.ItemTags.CROPRESSED_CROPS).add(MSFItems.CROPRESSED_CARROT.get(), MSFItems.CROPRESSED_POTATO.get(), MSFItems.CROPRESSED_WHEAT.get(), MSFItems.CROPRESSED_BEETROOT.get(), MSFItems.CROPRESSED_NETHERWART.get());
        this.tag(MSFTags.ItemTags.CROP_SMITHING_TEMPLATES).add(MSFItems.NETHER_WART_ARMOR_TRIM_SMITHING_TEMPLATE.get(), MSFItems.CAROTENE_ARMOR_TRIM_SMITHING_TEMPLATE.get(), MSFItems.BEAT_ARMOR_TRIM_SMITHING_TEMPLATE.get(), MSFItems.TATER_ARMOR_TRIM_SMITHING_TEMPLATE.get(), MSFItems.GRAIN_ARMOR_TRIM_SMITHING_TEMPLATE.get());

        this.tag(MSFTags.ItemTags.BLOCK_PATTERNS).add(MSFItems.BLOCK_PATTERN_PIPES.get(), MSFItems.BLOCK_PATTERN_BRICKS.get(), MSFItems.BLOCK_PATTERN_FOCUS.get(), MSFItems.BLOCK_PATTERN_BUBBLES.get(), MSFItems.BLOCK_PATTERN_CLOUDS.get(), MSFItems.BLOCK_PATTERN_DEEPSLATE.get(),
        ...
        this.tag(MSFTags.ItemTags.CROPRESSOR_PIECES).add(MSFItems.SCRAP_PIECE.get(), MSFItems.BELT_PIECE.get(), MSFItems.ENGINE_PIECE.get(), MSFItems.TUBE_PIECE.get(), MSFItems.PRESS_PIECE.get());

        this.tag(MSFTags.ItemTags.REBREWED_POTIONS).add(MSFItems.REBREWED_POTION.get(), MSFItems.REBREWED_SPLASH_POTION.get(), MSFItems.REBREWED_LINGERING_POTION.get());

        this.tag(MSFTags.ItemTags.VIVICUS_LOGS).add(MSFBlocks.VIVICUS_LOG.get().asItem(), MSFBlocks.VIVICUS_WOOD.get().asItem(), MSFBlocks.STRIPPED_VIVICUS_LOG.get().asItem(), MSFBlocks.STRIPPED_VIVICUS_WOOD.get().asItem() );
        this.tag(MSFTags.ItemTags.CORRUPTED_LOGS).add(MSFBlocks.CORRUPTED_LOG.get().asItem(), MSFBlocks.CORRUPTED_WOOD.get().asItem(), MSFBlocks.STRIPPED_CORRUPTED_LOG.get().asItem(), MSFBlocks.STRIPPED_CORRUPTED_WOOD.get().asItem() );
        this.tag(net.minecraft.tags.ItemTags.LOGS_THAT_BURN).addTags(MSFTags.ItemTags.CORRUPTED_LOGS, MSFTags.ItemTags.VIVICUS_LOGS);
        ...
        this.tag(MSFTags.ItemTags.COLORABLE)
        ...
        this.tag(MSFTags.ItemTags.MSF_SNIFFER_LOOT).add(MSFItems.DAWNBERRY_VINE_SEEDS.get(), MSFItems.DYESPRIA_SEEDS.get(), MSFItems.AMBUSH_SEEDS.get(), MSFItems.CAULORFLOWER_SEEDS.get(),
